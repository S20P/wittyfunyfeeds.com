<?php
$app_description =  "<b>".$posts->first_name."</b>, your message to the world is:<b>".$app_result."</b>";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">No matter what people tell you, you believe that words and ideas can change the world.</p>
          <p class="subtext">Share this beautiful result with your friends and let them know about your message to the world!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app12_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
