<?php
$app_description =  "<b>".$posts->first_name." ".$app_result."</b>";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this beautiful result with your partner and let others also know about this.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app44_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
