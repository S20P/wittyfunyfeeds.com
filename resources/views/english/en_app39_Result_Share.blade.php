<?php
$app_description =  "<b>".$posts->first_name."</b>,GOD is always there to help you and inspire you. He is there to give you courage, make you strong and help you achieve your goals of life.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this beautiful Bible Verse with everyone.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app39_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
