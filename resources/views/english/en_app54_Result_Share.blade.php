<?php
$app_description =  "Amazing!! <b>".$posts->first_name.",</b> these three things are common between you and M.S Dhoni ";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app54_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with your friends and let them know about common things between you and M.S Dhoni.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app54_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
