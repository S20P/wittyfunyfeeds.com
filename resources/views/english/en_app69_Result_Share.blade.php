<?php
$app_description =  "<b>".$posts->first_name."</b>,The way you live your life reflects the kind of soul you have. Remember to be a little more kinder, loving, and giving to those around you! ";
?>
  ...
  <div class="content-wrap box-shadow">
    <div class="item-img">
      ...
      <div class="text-animation-loder">
        <a href="" class="typewrite" data-period="2000" data-type='[ "Job All day...", "Everyday!" ]'>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app69_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Don't forget to share this with your friends! </p>
           </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app69_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
