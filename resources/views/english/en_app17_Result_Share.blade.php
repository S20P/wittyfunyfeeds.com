<?php
$app_description =  "AHA! That’s nice. <b>".$posts->first_name."</b>, you are such an extraordinary person that now you are tired of the compliments. There was a time when you felt great when people gave compliments, and now you won’t get excited about them anymore.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone and ask them to come up with something new.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app17_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
