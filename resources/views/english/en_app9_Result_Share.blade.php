<?php
$app_description =  "<b>".$posts->first_name."</b>,your mission in life is not merely to survive, but to thrive; and to do so with some passion, some compassion, some humor, and some style.";
?>
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          <p class="subtext"><?php echo $app_description;?> </p>
           <p class="subtext">All of life is peak and valley and don’t let the peaks get too high and the valley to low. Share this beautiful result with your friends and let them know about these words.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app9_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
