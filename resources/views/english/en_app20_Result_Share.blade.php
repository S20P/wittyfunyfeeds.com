<?php
$app_description =  "<b>".$posts->first_name."</b>, these are the three truths about you. No one knows about this except you. Now it’s the time to reveal it in public and collect some compliments and appreciation for yourself.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with your everyone and let them know about this.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app20_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
