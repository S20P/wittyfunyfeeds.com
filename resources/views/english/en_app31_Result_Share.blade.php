<?php
$app_description =  "<b>".$posts->first_name."</b>, Boo! Bet you didn't expect it. But, that's the truth. You are a <b>".$app_result."</b>  Halloween has been associated with scary monsters, strange creatures and you are one of them.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Let's share the result with your friends and family, Give them a chance to find out the Halloween creature they are!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app31_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
