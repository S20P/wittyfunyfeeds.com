<?php
$app_description =  "<b>".$posts->first_name."</b>, we respect your thought. You have a great heart and you always pray for well being of others. You always want the beautiful world where there are no false people and no one trying to pull each other down. ";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app53_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone and let them know what do you pray for!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app53_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
