<?php
$app_description =  "No kidding...<b>".$posts->first_name."</b> you are athletic, good-looking and brimming with self-confidence. With an innate understanding of the value of teamwork, you're always ready to take your place in the chain of command either as a leader or as simply a member of the pack. You are intensely ambitious and never shy from hard work.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone and let them know about your Wolf instincts.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app42_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
