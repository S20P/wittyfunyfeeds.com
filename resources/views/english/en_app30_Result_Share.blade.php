<?php
$app_description =  "<b>".$posts->first_name."</b>,your attitude is like a box of crayons that color your world. You always start a day with a grateful heart. Deep inside, you have a kind soul that shines brightly in this wonderful color. That's why this color reflects your best qualities as well. ";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app30_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share your result so your friends can also find out which color their heart is!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app30_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
