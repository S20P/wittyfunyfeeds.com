<?php
$app_description =  "This is what particularly stands out about you. Own your best features and flaunt them when you can!";
?>
  ...
  <div class="content-wrap box-shadow">
    <div class="item-img">
      ...
      <div class="text-animation-loder">
        <a href="" class="typewrite" data-period="2000" data-type='[ "The best thing is..." ]'>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app93_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app93_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
