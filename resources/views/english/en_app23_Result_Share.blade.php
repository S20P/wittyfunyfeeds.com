<?php
$app_description =  "<b>".$posts->first_name."</b>, you turn into <b>".$app_result."</b> when you get mad. You can become mad and angry at the same time, but you have some control. You know to be angry at the right person and to the right degree and at the right time and for the right purpose, and in the right way — that is not within everybody's power and is not easy. ";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result and beware people not to make you mad.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app23_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
