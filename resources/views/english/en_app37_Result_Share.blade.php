<?php
$app_description =  "<b>".$posts->first_name."</b>,you are  <b>".$app_result."</b> mean. This is absolutely right. You always believed in giving and helping others in your way. Sometimes you are so straightforward that people consider you a mean person, but that’s not true. You just don’t want to lose your identity and work accordingly. ";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app37_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone around you and tell them about it.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app37_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
