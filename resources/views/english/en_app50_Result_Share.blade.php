<?php
$app_description =  "Prepare your resume, <b>".$posts->first_name."</b>, this is the job for you! You are perfect for this career, and you know it. Step up and chase your dreams! ";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app50_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
