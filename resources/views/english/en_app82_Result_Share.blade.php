<?php
$app_description =  "You are blessed with good genes originating from such diverse roots. In the end, we are all ONE HUMAN RACE.";
?>
  ...
  <div class="content-wrap box-shadow">
    <div class="item-img">
      ...
      <div class="text-animation-loder">
        <a href="" class="typewrite" data-period="2000" data-type='[ "Tracing your roots..." ]'>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app82_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext">{{$app_description}}</p>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app82_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
