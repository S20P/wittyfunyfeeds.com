<?php
$app_description =  "<b>".$posts->first_name."</b>, you are you coz: <b>".$app_result."</b>";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone and let them know about yourself.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app26_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
