...
<?php
$app_description =  "<b>".$posts->first_name."</b>, this phrase perfectly describes you. You are the person of your principles. You will never leave the path of truth, no matter what the situation is! You are a bit creative too and always open to learn new things. You live your life to the fullest and enjoy every moment of it.";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app8_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this beautiful result with everyone and let them know about this.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app8_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
