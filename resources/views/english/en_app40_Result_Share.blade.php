<?php
$app_description =  "No kidding...<b>".$posts->first_name."</b> you act like a <b>".$app_result1."</b> , thinks like a <b>".$app_result2."</b>  and looks like a <b>".$app_result3."</b>.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result with your friends and tell them about it.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app40_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
