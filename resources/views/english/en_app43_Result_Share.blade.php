<?php
$app_description =  "No doubt 2018 will be much better than 2017 for you. <b>".$app_result."</b> in 2018. Gear up for it. ";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result with your buddies and tell them about it.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app43_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
