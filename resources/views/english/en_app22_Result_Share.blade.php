<?php
$app_description =  "Wow <b>".$posts->first_name.".</b> This is how your ID Card would look like if you would join Indian Army. You sleep peacefully at your homes because Indian Army is guarding frontiers. Let us salute the Army";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result with everyone and let them make their ID Card.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app22_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
