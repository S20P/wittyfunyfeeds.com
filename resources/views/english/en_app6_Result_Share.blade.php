<?php
$app_description = "<b>".$posts->first_name."</b>,this how your greeting card will look like.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Tag your friends and share this greeting card with everyone to wish a Happy new Year 2018.</p>
           </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app6_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
