<?php
$app_description =  "Wow <b>".$posts->first_name."</b>! You would get married at the age of <b>".$app_result."</b>. The real act of marriage takes place in the heart, not in the ballroom or church or synagogue. It's a choice you make–not just on your wedding day, but over and over again–and that choice is reflected in the way you treat your husband or wife.";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app21_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result with your friends and let them find out their age of marriage.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app21_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
