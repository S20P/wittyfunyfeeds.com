      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <p class="subtext"><?php echo $app_description;?></p>
          <p class="subtext">Share this result with your friends and let them know about the strength god blessed them with.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app16_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
