<?php
$app_description =  "It looks like 2018 is going to be an amazing year for you, <b>".$posts->first_name."</b>! 2018 can't come soon enough!";
?>
  ...
  <div class="content-wrap box-shadow">
    <div class="item-img">
      ...
      <div class="text-animation-loder">
        <a href="" class="typewrite" data-period="2000" data-type='[ "Happy 2018" ]'>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app76_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this prediction with your family and friends!</p>
           </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app76_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
