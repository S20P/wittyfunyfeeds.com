<?php
$app_description =  "<b>".$posts->first_name."</b>, It runs in your blood...You are <b>You are Half-Human & ".$app_result."</b> Feel free to spread the news ";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">share the result on social media</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app34_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
