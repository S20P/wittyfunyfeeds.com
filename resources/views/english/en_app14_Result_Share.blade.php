<?php
$app_description =  "<b>".$posts->first_name."</b>,  you are an expert in hiding many facts about you. Nobody can predict what’s running in your mind through your face too.";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app14_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext"> <b>{{$app_result}}</b></p>
          <p class="subtext">Share the result with your friends and reveal your secrets.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app14_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
