<?php
$app_description =  "<b>".$posts->first_name."</b>,see what your warning label says. You love your attitude and never regret your decisions once taken.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app10_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
