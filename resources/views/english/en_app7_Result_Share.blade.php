<?php
$app_description =  "<b>".$posts->first_name."</b>, You're life is going to be perfect! You deserve a wonderful future, because you always try to have a positive attitude towards life.";
?>
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          <p class="subtext"><?php echo $app_description;?></p>
           <p class="subtext">Think this is the life for you? Share this result with your friends!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app7_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
