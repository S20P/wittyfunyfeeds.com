<?php
$app_description =  "<b>".$posts->first_name."</b>, that’s your 6-word story. You never really mind what people say about you - you are far too unconventional and far too dedicated to being true to yourself.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this amazing result and give your friends a chance to create their 6-word story.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app48_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
