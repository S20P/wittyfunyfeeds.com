<?php
$app_description =  "You bring light and warmth with you wherever you go. Your family and friends are lucky to have someone like you!";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app49_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
