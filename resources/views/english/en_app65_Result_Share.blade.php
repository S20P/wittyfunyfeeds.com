<?php
$app_description =  "What do you think, <b>".$posts->first_name."</b>? Thinking of switching careers already? You've got these three to choose from!";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app65_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app65_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
