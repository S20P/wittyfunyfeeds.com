<?php
$app_description =  "Everyone has their own wild streaks. You are not totally crazy, but you just think and behave totally more fun and random than the rest!";

$app_description_og =$app_description;
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app3_img" src="{{asset($img_url)}}" alt="">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share with your friends and family, and let them see their own level of craziness!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app3_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
