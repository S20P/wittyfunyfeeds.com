<?php
$app_description =  "It's hard at first, messy in the middle, but glorious at the end. Take the first step today!";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app59_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext"> Don't forget to share this result with your friends, and have yourselves an unrecognizable but beautiful year!</p>
     </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app59_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
