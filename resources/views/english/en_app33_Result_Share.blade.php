<?php
$app_description =  "OMFG! <b>".$posts->first_name."</b>, you are going to get a chance of RAP TRAINING from none other than <b>".$app_result."</b> . Yes, we know, it's unbelievable but it's true. This is one in a lifetime chance which will get soon. All you need is to spread the news.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result with your friends and tell the whole world about it good news.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app33_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
