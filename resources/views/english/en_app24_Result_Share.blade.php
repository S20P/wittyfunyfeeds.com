<?php
$app_description =  "<b>".$posts->first_name."</b>, the decision which can change your life forever and become the smartest one ever is";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share the result and let your friends know what your next big decision will be.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app24_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
