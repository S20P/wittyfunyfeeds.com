<?php
$app_description =  "<b>".$posts->first_name."</b>, your Love First Aid box contains: <br> <b>".$app_result1."</b> <br> <b>".$app_result2."</b> <br> <b>".$app_result3."</b>";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">You believe that love is the only component that makes life complete and worth living. Share this result with everyone and let them know about your Love First Aid Box.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app28_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
