<?php
$app_description =  "Years from now, people will turn to your success story for inspiration. They will know what you are capable of, and that your actions are worth emulating.";
?>
  ...
  <div class="content-wrap box-shadow">
    <div class="item-img">
      ...
      <div class="text-animation-loder">
        <a href="" class="typewrite" data-period="2000" data-type='[ "Reviewing life story..." ]'>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app57_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">SHARE your biography with your friends and family!</p>
        </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app57_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
