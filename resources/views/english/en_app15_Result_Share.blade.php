<?php
$app_description =  "<b>".$posts->first_name."</b>,<b>".$app_result."</b> is a perfect word that reflects your love life. You love your partner a lot and always try to keep them happy and safe. Their happiness matters a lot to you, and you arrange frequent surprises and gifts to keep your love refreshing and exciting.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Tag your love; share this result with everyone and let them also discover the word that reflects their love life.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app15_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
