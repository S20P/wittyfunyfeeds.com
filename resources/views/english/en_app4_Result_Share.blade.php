<?php
$app_description = "The future is looking very bright, <b>".$posts->first_name."</b>! The change in your appearance is unbelievable!";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share with your family and friends!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app4_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
