<?php
$app_description =  "<b>".$posts->first_name."</b>,you belong to <b>".$app_result."</b>. You have such an amazing voice and knows to play many instruments. You deserve to be in <b>".$app_result."</b>";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with everyone and let them know about this.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app19_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
