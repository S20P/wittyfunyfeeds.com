<?php
$app_description =  "<b>".$posts->first_name."</b>,you would date <b>".$app_result."</b> in future. You both share the common interest and nature. You look perfect with each other and when someone comes into your life God sent them for a reason, Either to learn from them or to be with them until the end.";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app29_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share this result with your friends and make them jealous.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app29_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
