<?php
$app_description =  "<b>".$posts->first_name."</b>,your heart is a secret garden and the walls are very high. No one can guess what's inside your heart, unless and until you open your heart. Things you are hiding inside your heart worthy enough. ";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Share it with everyone and let them know about that hidden secret.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app47_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
