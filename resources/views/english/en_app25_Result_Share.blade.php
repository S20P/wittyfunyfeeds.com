<?php
$app_description =  "<b>".$posts->first_name."</b>,these are the five facts about you. No beauty shines better than that of your good heart.";
?>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
         ...
         <div class="app-box-info">
          ...
          <p class="subtext">Your every struggle of your life has shaped you into the person you are today. BE THANKFUL for the hard time you had; they can only make you STRONGER.</p>
          <p class="subtext">Share this result with your friends and let them know facts about you.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app25_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
