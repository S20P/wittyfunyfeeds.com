<?php
$app_description =  "<b>".$posts->first_name."</b>,the secret of your future is hidden in your daily routine. You don’t need the other’s eyes to see the world, you have your own perspective towards life and live it to your style.";
?>
  ...
  <div class="content-wrap box-shadow">
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app52_img" src="{{asset($img_url)}}" alt="">
         </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          ...
          <p class="subtext">Share your secrets with everyone and let them know about your 5 secrets of living a happy life.</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="en_app52_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
