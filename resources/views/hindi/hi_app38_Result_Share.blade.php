...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">कौनसा फ़ोन आपके लिए बना है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app38_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
           <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>,आपके लिए सबसे बेस्ट फ़ोन है <b>{{$app_result}} </b> ! ये फ़ोन आपकी पर्सनालिटी को एक दम सही से मैच करता है। अगर आपने अभी तक ये फ़ोन नहीं खरीदा है तोह इसे तुरंत खरीदने का प्लान करें! </p>
           <p class="subtext">उत्तर को साझा करके अपने दोस्तों को भी ये फ़ोन दिखाएं।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app38_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'कौनसा फ़ोन आपके लिए बना है?',
