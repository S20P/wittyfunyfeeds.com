...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app3/home_image_app3.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">2017 ख़तम होने से पहले आपको कौनसे काम पूरे कर लेने चाहिए?</p>
        <p class="subtext">
          आइये हम आपको बताते हैं वो काम जो आपको 2017 ख़तम होने से पहले करलेने चाहिए! खेलें और जाने!
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app3_createimg()">
