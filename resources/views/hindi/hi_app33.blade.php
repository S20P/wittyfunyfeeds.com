...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app33/home_image_app33.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपने कितने दिलों को चुराया, तोडा और ठीक किया है?</p>
        <p class="subtext">
          खेले और पता करें कि आपने कितने दिलों को चुराया, तोडा और ठीक किया है?
        </p>
        <!-- <p class="subtext">
        3318 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">
          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app33_createimg()">
