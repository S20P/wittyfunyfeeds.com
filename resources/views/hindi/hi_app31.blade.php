...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app31/home_image_app31.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">2018 में आपके पास कौन सी तीन चीजें होंगी?</p>
        <p class="subtext">
        खेलें और पता करें कि 2018 मे आपके पास कौनसी 3 चीज़े होंगी?
        </p>
        <!-- <p class="subtext">
        3118 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app31_createimg()">
