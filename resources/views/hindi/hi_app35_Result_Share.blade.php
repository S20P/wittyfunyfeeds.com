...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आप देवता हैं या राक्षस?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
          ...
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext">कोई भी पूरी तरह से देवता नहीं बन सकता है और ना ही आप हैं! आप  <b>{{$app_result1}} </b> रतिशत देवताओं की प्रवर्ति के हैं और  <b>{{$app_result2}} </b> प्रतिशत राक्षसों की! </p>
         <p class="subtext">अपने उत्तर को दोस्तों के साथ शेयर करके जानो को वो क्या हैं, देवता या राक्षस?</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app35_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आप देवता हैं या राक्षस?',
