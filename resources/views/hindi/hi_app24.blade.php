...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app24/home_image_app24.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आप कौनसे सुपरस्टार की तरह दिखते हैं?</p>
        <p class="subtext">
      खेलें और पता करे आप किस सुपरस्टार दिखते हैं?
        </p>
        <!-- <p class="subtext">
        2418 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app24_createimg()">
