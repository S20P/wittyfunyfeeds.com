...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app10/home_image_app10.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">2018 से आप क्या expect कर सकते हो?</p>
        <p class="subtext">
              आने वाला नया साल 2018 आपके लिए क्या खास ला सकता है?
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app10_createimg()">
