...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app26/home_image_app26.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">भगवान आपसे प्रस्सन हो जाये तो आप क्या वरदान मांगोगे?</p>
        <p class="subtext">
          खेलें और पता करें कि भगवान् से आप क्या वरदान मांगेंगे?
        </p>
        <!-- <p class="subtext">
        2618 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app26_createimg()">
