...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app2/home_image_app2.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">कौनसा तीर्थ-स्थान आपको बुला रहा है?</p>
         <p class="subtext">
            जल्दी ही आप कौनसे तीर्थ-स्थान जाएंगे? खेलें और पता करें!
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app2_createimg()">
