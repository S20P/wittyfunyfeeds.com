...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आप कौनसे सुपरस्टार की तरह दिखते हैं?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app24_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p  class="subtext"><b> <?php echo $posts->first_name; ?> </b>, आपका चेहरा <b>{{$app_result}}</b> से बहुत मिलता हैं। ना की सिर्फ चेहरा बल्कि आपकी बहुत सी आदतें भी <b>{{$app_result}}</b> से काफी मेल खाती है। आने वाले समय में आप भी इनकी तरह बहुत मशहूर होंगे और आपके पास भी इनके जितनी दौलत और शौरहत होगी। </p>
          <p class="subtext">इस उत्तर को सभी के साथ साझा करें और सबको इसके इसके बारे में बताएं।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app24_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आप कौनसे सुपरस्टार की तरह दिखते हैं?',
