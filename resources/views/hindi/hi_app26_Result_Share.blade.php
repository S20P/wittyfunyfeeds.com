...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">भगवान आपसे प्रस्सन हो जाये तो आप क्या वरदान मांगोगे?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app26_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, आप भगवान् से <b>{{$app_result}}</b>  मांगेंगे। वैसे तो भगवान् की कृपा दृष्टि आप पर हमेशा रहती है और आगे भी रहेगी।</p>
          <p class="subtext"> इस उत्तर को सभी के साथ साझा करें और आपने वरदान के बारे बताएं।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app26_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'भगवान आपसे प्रस्सन हो जाये तो आप क्या वरदान मांगोगे?',
