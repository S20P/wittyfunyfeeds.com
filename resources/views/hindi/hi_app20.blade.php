...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app20/home_image_app20.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">जानिए आपकी किस्मत कब चमकेगी?</p>
        <p class="subtext">
      खेलें और पता करें की आपकी किस्मत कब चमकने वाली है?
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app20_createimg()">
