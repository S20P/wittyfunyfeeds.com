...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app29/home_image_app29.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपके होने वाले बच्चों का नाम क्या होना चाहिए?</p>
        <p class="subtext">
          खेलें और जाने की आपके अपने होने वाले बच्चों का नाम क्या रखने चाहिए?
        </p>
        <!-- <p class="subtext">
        2918 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app29_createimg()">
