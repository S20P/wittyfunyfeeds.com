...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app21/home_image_app21.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपको अगले साल क्या सरप्राइज मिलने वाला है?</p>
        <p class="subtext">
      खेलें और अपने अगले साल के सरप्राइज के बारे में जाने!
        </p>
        <!-- <p class="subtext">
        2118 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app21_createimg()">
