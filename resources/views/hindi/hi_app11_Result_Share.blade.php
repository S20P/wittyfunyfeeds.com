...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">जाने गणपति जी आपसे क्या कहना चाहते हैं?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
          ...
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, गणपति जी आपसे कहना चाहते हैं की <b> {{$app_result}} </b>  गणपति जी की बात पर गौर करें और उसे follow करने की कोशिश करें। </p>
            <p class="subtext">ये आप बात आप अपने सभी दोस्तों के साथ साझा कर सकते हो। उत्तर को अभी शेयर करो।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app11_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'जाने गणपति जी आपसे क्या कहना चाहते हैं?',
