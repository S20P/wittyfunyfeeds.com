...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app38/home_image_app38.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">कौनसा फ़ोन आपके लिए बना है?</p>
        <p class="subtext">
        खेले और जाने कौनसा फ़ोन आपका बेस्ट मैच है?
        </p>
        <!-- <p class="subtext">
        3818 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app38_createimg()">
