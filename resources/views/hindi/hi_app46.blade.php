...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app46/home_image_app46.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
      ...
      खेले और पता लगायें कि कितने लोगो ने आपसे 2017 में प्यार किया और कितनो ने नफरत की?
        ...
        <!-- <p class="subtext">
        4618 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app46_createimg()">
