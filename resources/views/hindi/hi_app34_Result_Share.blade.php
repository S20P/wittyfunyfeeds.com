...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">अपनी ‘जय श्री राम’ की फोटो बनाये और शेयर करें!</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app34_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
           <p class="subtext">‘जय श्री राम’ <b> <?php echo $posts->first_name; ?> </b>! राम नाम जपिये और भगवान् ने हमें जो भी दिया है उसका शुक्रिया करें! </p>
          <p class="subtext">इस सुन्दर को फोटो सभी राम-भक्तों के साथ अभी साझा करें!</h2>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app34_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'अपनी ‘जय श्री राम’ की फोटो बनाये और शेयर करें!',
