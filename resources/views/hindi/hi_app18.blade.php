...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app18/home_image_app18.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपकी फेसबुक प्रोफाइल में आपके लिए क्या सन्देश छुपा है?</p>
        <p class="subtext">
          आपका फेसबुक प्रोफाइल में आपके लिए एक सन्देश छुपा है? जाने क्या?
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app18_createimg()">
