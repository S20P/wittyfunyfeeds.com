...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आपकी कौन सी फोटो गैलरी में लटकनी चाहिए?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app13_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext">वाह! क्या बात है, <b> <?php echo $posts->first_name; ?> </b>? आपकी फोटो गैलरी में लटकते हुए कितनी अच्छी और सुन्दर लग रही है। अपनी इस सुन्दर फोटो को दोस्तों के साथ साझा करें और बाक़िओं को भी अपनी फोटो बनाने का मौका दें!</p>
          <p class="subtext">ये आप बात आप अपने सभी दोस्तों के साथ साझा कर सकते हो। फोटो गैलर को अभी शेयर करो।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app13_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आपकी कौन सी फोटो गैलरी में लटकनी चाहिए?',
