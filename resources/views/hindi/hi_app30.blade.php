...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app30/home_image_app30.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">जानिए आपकी जिंदगी मे और कितने साल बाकि हैं?</p>
        <p class="subtext">
          क्या हम बता सकते हैं की आपकी सुन्दर सी जिंदगी में और कितने साल बाकी हैं?
        </p>
        <!-- <p class="subtext">
        3018 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
        <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app30_createimg()">
