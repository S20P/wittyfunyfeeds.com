...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app9/home_image_app9.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">वह क्या एक चीज़ है जो आप में कभी नहीं बदल सकती?</p>
        <p class="subtext">
      क्या आप जानना चाहते है वह क्या एक चीज़ है जो आपमें कभी नहीं बदल सकती? खेले और पता लगाएं।
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app9_createimg()">
