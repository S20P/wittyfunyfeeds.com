...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app23/home_image_app23.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपकी PROFILE आपके बारे में क्या 4 चीज़े बताती है?</p>
        <p class="subtext">
  खेलें और पता लगाएं कि आपकी प्रोफाइल आपके बारे में क्या कहती हैं?
        </p>
        <!-- <p class="subtext">
        2318 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app23_createimg()">
