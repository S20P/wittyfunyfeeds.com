...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app32/home_image_app32.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपके दिमाग, शरीर और आत्मा कि उम्र क्या है?</p>
        <p class="subtext">
      खेले और पता कीजिये अपनी उम्र के बारे में?
        </p>
        <!-- <p class="subtext">
        3218 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app32_createimg()">
