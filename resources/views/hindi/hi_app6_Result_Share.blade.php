...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आपके हमसफ़र के नाम का पहला अक्षर क्या होगा?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app6_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, आपके हमसफर के नाम का पहला अक्षर <b>{{$app_result}}</b> से शुरु होगा। आपके लिए आपके हमसफ़र बहुत ही भाग्याशाली होंगे और आपके जीवन को ढेर सारी खुशियाँ से भर देंगे।</p>
        <p class="subtext">इस उत्तर को सभी के साथ साझा करे और इसके बारे में बतायें।</p>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app6_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आपके हमसफ़र के नाम का पहला अक्षर क्या होगा?',
