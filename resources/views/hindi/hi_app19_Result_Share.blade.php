...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">जानिये आइना आपके बारे में क्या कहता है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app19_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, आइना हर आपके बारे में हर सच्चाई जनता हैं। आइने के अनुसार <b>{{$app_result}}</b> । जितना आप अपने बारे में नहीं जिंटा उतना आपका आइना जनता है और आइना कभी झूठ नहीं बोलता। </p>
          <p class="subtext">इस उत्तर को सभी के साथ साझा करें और उनको भी आइना दिखाए।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app19_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'जानिये आइना आपके बारे में क्या कहता है?',
