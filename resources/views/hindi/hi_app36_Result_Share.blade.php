...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">बाहुबली-मूवी का कौनसा डायलॉग आप पर सूट करता है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app36_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
              <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, ‘बाहुबली’ का ये डायलॉग आप पर सूट करता है: <b>{{$app_result}} </b> </p>
              <p class="subtext">हमें पता है आपने डायलॉग को उसी तरह से बोलकर देखा होगा जैसा वो पिक्चर में है। ये डायलॉग है ही इतना बढ़िया! खैर, अपने दोस्तों के साथ इस डायलॉग को शेयर जरूर करें!</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app36_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'बाहुबली-मूवी का कौनसा डायलॉग आप पर सूट करता है?',
