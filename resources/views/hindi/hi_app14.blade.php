...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app14/home_image_app14.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आप कितने सुन्दर हो?</p>
        <p class="subtext">
          आइये हम आपकी सुंदरता को आंकते हैं!
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app14_createimg()">
