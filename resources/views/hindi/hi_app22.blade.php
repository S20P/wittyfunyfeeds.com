...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app22/home_image_app22.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">कौनसे 4 शब्द आपकी पर्सनालिटी को दर्शाते हैं?</p>
        <p class="subtext">
      खेलें और अपनी पर्सनालिटी के उप्पर कोनसे 4 शब्द सूट करते है वो जाने!
        </p>
        <!-- <p class="subtext">
        2218 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app22_createimg()">
