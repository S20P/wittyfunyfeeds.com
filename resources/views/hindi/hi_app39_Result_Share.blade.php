...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आपने अपने जीवन में कितने अच्छे कर्म और शरारती पाप किये है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app39_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p  class="subtext"><b> <?php echo $posts->first_name; ?> </b>,आपने बचपन में बहुत से अच्छे काम और शरारतें करी है। आप बचपन में बहुत नटखट थे और सबके के प्यारे थे।</p>
         <p class="subtext">इस उत्तर को सब के साथ साझा करे बताये कि आप कितने शरारती थे।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app39_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आपने अपने जीवन में कितने अच्छे कर्म और शरारती पाप किये है?',
