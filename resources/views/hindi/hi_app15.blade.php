...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app15/home_image_app15.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">भगवान् ने आपको धरती पर क्यों भेजा है?</p>
        <p class="subtext">
          जाने भगवान् ने आपको धरती पर क्यों भेजा है? आइये इस गुथी को सुलझाएं।
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          @if (Auth::check())
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app15_createimg()">
