...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app12/home_image_app12.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">जानिये आपकी आत्मा की उम्र कितनी है?</p>
        <p class="subtext">
            आइये हम आपको बताते हैं की आपकी आत्मा की उम्र कितनी है?
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app12_createimg()">
