...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app28/home_image_app28.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">आपके खून में अपने माता पिता के कौनसे गुण हैं?</p>
        <p class="subtext">
        खेलें और पता लगाएं आप ने अपने माता - पिता से क्या गुण प्राप्त किये हैं?
        </p>
        <!-- <p class="subtext">
        2818 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app28_createimg()">
