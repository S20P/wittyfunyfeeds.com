...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">लोग आपके चेहरे में सबसे पहले क्या देखते हैं?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
          ...
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, सबसे पहले लोग आपके चेहरे पर <b>{{$app_result}}</b> देखते हैं। आप हैं ही इतने प्यारे कि लोग आपकी हर बात पर गौर फरमाते हैंऔर आपको दो टुक देखते रहते हैं। </p>
           <p class="subtext">इस उत्तर को सबके के साथ साझा करे और बताएं कि लोग आपके चेहरे में सबसे पहले क्या देखते हैं।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app4_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'लोग आपके चेहरे में सबसे पहले क्या देखते हैं?',
