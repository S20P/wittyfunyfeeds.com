...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">कितने लोगो ने आपसे 2017 में प्यार किया और कितनो ने नफरत की?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app40_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
           <p class="subtext">बहुत खूब <b> <?php echo $posts->first_name; ?> </b>, आपसे प्यार करने वालो की संख्या जयादा है। आपका व्यव्हार इतना अच्छा है कि सभी लोगो को आपसे प्यार हो जाता है परन्तु कुछ लोग आपसे इर्षा भी करते है क्यूंकि वो आपकी कामयाबी से जलते है। </p>
           <p class="subtext">इस उत्तर को अपने सभी दोस्तों के साथ साझा करे और बताएं।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app40_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'कितने लोगो ने आपसे 2017 में प्यार किया और कितनो ने नफरत की?',
