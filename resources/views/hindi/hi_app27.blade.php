...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app27/home_image_app27.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">जानिए लोग आपकी किन 3 बातों से प्यार करते हैं?</p>
        <p class="subtext">
          खेलें और पता लगाएं लोग आपकी किन 3 बातों से प्यार करते हैं?
        </p>
        <!-- <p class="subtext">
        2718 में आप कौनसी कार खरीदेंगे?</p> -->
        <div class="btns-quiz">

          @if (Auth::check())

          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app27_createimg()">
