...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      <div class="share-btn-header">
        <div class="item-img-content">
         ...
         <p class="subtext">भगवान् ने आपको धरती पर क्यों भेजा है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app15_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext">चौकिये मत! <b> <?php echo $posts->first_name; ?> </b>, आपको भगवान् ने धरती पर <b>{{$app_result}}</b> भेजा है।</p>
          <p class="subtext">ये काम आप काफी अच्छे से कर रहे हैं और अगर नहीं कर रहे हैं तो काम पे लग जाएं। अपने सभी दोस्तों के साथ इस उत्तर को शेयर करें और जाने भगवन ने उनको धरती पे क्यों भेजा है।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app15_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'भगवान् ने आपको धरती पर क्यों भेजा है?',
