...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">2018 मे कितने लोगों को आप DATE करेंगे?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
              <img class="img img-responsive reimg" width="100%"  height="auto" id="app5_img" src="{{asset($img_url)}}" alt="">
       </div>
       </div>
        </div>
          <div class="item-img-content">
         <div class="app-box-info">
          <p class="subtext"><b> <?php echo $posts->first_name; ?> </b>, अगले साल आपकी तो चांदी ही चांदी है क्यूंकि आपको <b>{{$app_result}}</b> लोगों को DATE करेंगे। आप है ही इतने ही अच्छे और प्यारे कि कौन आपके साथ DATE पर नहीं जाना चाहेगा। तो त्यार हो जाइये 2018 से आपको बहुत अलग अलग किस्म के लोग मिलने वाले है और बहुत सारी चौका देने वाली बाते भी होने वाली है। </p>
          <p class="subtext">इस उत्तर को सभी के साथ साझा करे और इसके बारे में बतायें।</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app5_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': '2018 मे कितने लोगों को आप DATE करेंगे?',
