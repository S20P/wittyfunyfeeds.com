...
<div class="content-detail-page"  id="loader-sec-in">
  <div class="content-wrap box-shadow">
    <div class="item-img">
    <img class="img img-responsive" width="100%"  height="auto" src="{{ asset('images/hindi/app5/home_image_app5.png') }}" alt="">
    </div>
    <div class="item-img-content">
      <div class="padding-2rem">
       <p class="title">2018 मे कितने लोगों को आप DATE करेंगे?</p>
        <p class="subtext">
        क्या आप ये जानने के लिए उत्सुक है कि 2018 मे कितने लोगों को आप DATE करेंगे? खेले और पता लगायें!
        </p>
        <!-- <p class="subtext">
        ...
        <div class="btns-quiz">
          ...
          <button type="button"  class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow disabled" onClick="hi_app5_createimg()">
