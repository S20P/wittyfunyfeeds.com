...
<div class="app-box-panel" id="loader-sec-in">
  <div class="content-wrap box-shadow">
      ...
      <div class="share-btn-header">
        ...
        <div class="app-box-info">
         <p class="subtext">आपको अगले साल क्या सरप्राइज मिलने वाला है?</p>
      ...
      <button type="button" class="btn-start wb-btn wb-btn-lg wb-btn-fb btn-shadow" onclick="myFacebookLogin()">
        ...
        <div class="border-img">
          ...
          <div class="item-img-content">
         <div class="app-box-info">
          <p  class="subtext"> <b> <?php echo $posts->first_name; ?> </b>, 2018 से आपके अच्छे दिन आने वाले है। आपको लोगो का बेशुमार प्यार और बहुत सारे SUPRISES भी मिलेंगे। आपका सरप्राइज बहुत होने होगा और शायद आप बिकुल दंग रह जाएँ। आपने सरप्राइज को सभी के साथ साझा करें और दुसरो को भी उनका सरप्राइज जानने का मौका दें। </p>
          <p class="subtext">उत्तर को अपने सभी दोस्तों के साथ शेयर करके ये खुशखबरी बांटे</p>
         </div>
         ...
         <div class="box-button">
           ...
           <button class="try-again-btn disabled" onclick="hi_app21_createimg()"><span></span>Try Again</button>
         </div>
       </div>
  </div>
</div>
  ...
  // console.log(path);
     ...
     action_properties: JSON.stringify({
         object : {
            'og:url': '{{ asset('/')}}',
            'og:title': 'आपको अगले साल क्या सरप्राइज मिलने वाला है?',
